...
$route['^(\w{2})/testimonial']                       = 'feedbacks/feedbacks/dispatcher/send_feedback';

// back end
$route['^dashboard/feedbacks']                      = 'feedbacks/feedbacks_admin/dispatcher/list_feedbacks/vi/1';
$route['^dashboard/feedbacks/(\w{2})']              = 'feedbacks/feedbacks_admin/dispatcher/list_feedbacks/$1/1';
$route['^dashboard/feedbacks/(\w{2})/page-(\d+)$']  = 'feedbacks/feedbacks_admin/dispatcher/list_feedbacks/$1/$2';
