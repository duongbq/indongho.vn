<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../images/news'; // absolute or relative from this script path, required.
	$mcImageManagerConfig['filesystem.datefmt'] = "Y-m-d H:i";
	$mcImageManagerConfig['filesystem.include_directory_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_directory_pattern'] = '/^thumbnails/i';
	$mcImageManagerConfig['filesystem.invalid_directory_name_msg'] = "";
	$mcImageManagerConfig['filesystem.include_file_pattern'] = '';
	$mcImageManagerConfig['filesystem.exclude_file_pattern'] = '/([^a-zA-Z0-9_\-\.]|^xmcic_)/i';
	...
	$mcImageManagerConfig['thumbnail.height'] = "115"; // px
	...
	$mcImageManagerConfig['thumbnail.folder'] = "thumbnails"; // required, exclude this folder with file pattern '/^mcith$/i' if you don't want it to show
